...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZettelKasten " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zettelkasten.com", "dnsseed.zettelkasten.com"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0x0CF4FCD5,0x020CFF82,0x0282E605,
    0x0C22EC97,0x9C713A4D,0xB5F4FCD5,
    0xEE3319B9,0x03F92305,0x7132D959,
    0xCE0C528C,0x2542F6CF,0xC13219B9,
    0xC811A51F,0x5B616978,0xB73219B9,
    0xCEFD2305,0xE98451AC,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZettelKasten is probably already running."), addrBind.ToString().c_str());
        else
